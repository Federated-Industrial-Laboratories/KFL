...
" * here mirror the actuator library's own, so the figure is the one\n"
" * the dynamics saw and not the one the program assigned. */\n"
...
"            o[8] = u * KFLRL_THRSC(h, e, vi) * d->max_thrust;\n"
"            o[9] = d->max_thrust;\n"
"        }\n"
"#endif\n"
"    }\n"
